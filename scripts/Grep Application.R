...

{
  ...
  isFahrenheit = grep(pattern = " |F|Fahr|f", x=classData2$temp);
  ...
  temp_F[isCelsius] = (9/5) * temp_F[isCelsius] + 32;
  classData2$Fahrenheit = temp_F;
  
  celsiusTemps = (5/9)*(temp_F - 32);
  classData2$Celsius = celsiusTemps
  classData2$Kelvin = celsiusTemps+32
